        ...
        <div className="space-y-20">
          {orders.map((order: any, orderIndex: number) => (
            <div key={order._id.toString()} className="group relative">
              ...
              <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-8 pb-4 border-b border-[#2B2A28]/10">
                <div className="flex items-baseline gap-4">
                  ...
                  <div>
                    ...
                    <p className="font-mono text-[11px] text-[#2B2A28] opacity-60 uppercase">
                      {order._id.toString()}
                    </p>
              ...
              {/* Footer */}
              <div className="mt-10 pt-8 flex justify-between items-end bg-[#8B6F47]/5 p-8 rounded-sm">
                <div>
                ...
                <div className="text-right">
                  ...
                  <p className="text-4xl font-serif italic tracking-tighter">
